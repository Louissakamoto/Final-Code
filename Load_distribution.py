...
def internalcalculator(V_eas, h, n, fcheck, payload):
    ...
    CL0 = 0.308516  #CL at zero aoa
    CL10 = 1.159304  #CL at 10 degrees aoa
    engine_thrust_arm = 1.6  #m
    engine_mass_arm = 3.2  #m
    engine_y = 7.75  #m
    maximumpayload = 18960 #kg

    #get the relevant rows from the text files from XFLR 5
    data0 = np.genfromtxt('a0.txt', skip_header=21, skip_footer=1029)
    data10 = np.genfromtxt('a10.txt', skip_header=21, skip_footer=1029)
